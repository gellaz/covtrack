...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(tot) => "Total destinations reached: ${tot}";

  static m2(tot) => "Total number of trips: ${tot}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "oldDestinations" : MessageLookupByLibrary.simpleMessage("Old Destinations"),
    "oldDestinationsLoadFailure" : MessageLookupByLibrary.simpleMessage("Failed loading old destinations"),
